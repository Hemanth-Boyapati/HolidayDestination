...
<DOCTYPE HTML>
                    ...
                    {	?>
                        <div>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6">
                                    <?php echo htmlentities($result->Place_name);?>
                                </td>
                                <td class="py-4 px-6">
                                    <?php echo htmlentities($result->Location_id);?>
                                </td>
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql1 = "insert into place(Place_name, Location_id) values ('$Place_name', $Location_id)";
    ...
    <div class="mt-3" style="position: absolute;padding-left: 1100px;padding-right: 20 px; float: right">
        ...
        <form  method="POST" action="">
            <div class="p-6 max-w-sm h-auto backdrop-invert bg-white/50 rounded-lg border border-gray-200 shadow-md">
                <div class="mb-6">
                    <label for="Place_name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">Place_name</label>
                    <input type="name" name="Place_name" id="Place_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
                <div class="mb-6">
